...
export const App: React.FC = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ScrollTrigger.create({
        ...
        scrub: 1.2, // Controlled momentum damping preventing wheel skipping
        onUpdate: (self) => {
  ...
  return (
    <div className="relative w-full bg-[#faf9f6] text-[#0f2d21] font-sans">
      ...
      {/* Full-Screen WebGL 3D Botanical Scene — only shown once past hero */}
      <div
        style={{
      ...
      {/* Hero Initial Overlay — photorealistic botanical background */}
      ...
      {/* 500vh Virtual Scroll Space for Controlled Pinned 5-Chapter Storytelling */}
      <div ref={scrollSpaceRef} className="relative w-full h-[500vh] pointer-events-none" />

      {/* Main Production Website Sections */}
